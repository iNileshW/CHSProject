...
public class TC_Ward_Add_Reset {
  ...
  public void f() {
	  ...
	  pageObjects.AddNewWardList.reset_Button(driver).click();
	  assertEquals("",pageObjects.AddNewWardList.Ward_Name(driver).getText());
	  pageObjects.AddNewWardList.backtolist(driver).click();
