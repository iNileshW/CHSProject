...
public class TC_Archived_Jobs_RecordPerPage {
  ...
  public void f() {
	  ...
	  String rcount = pageObjects.ArchivedJobsPage.RecordCount(driver).getText();
	  /*PageNavigation_Action.Execute(driver, pageObjects.ArchivedJobsPage.Recordpp(driver),rcount);*/
	  
	  int count = Integer.parseInt(rcount.substring(15,17));
	  	  
	  String[] ddcount = pageObjects.ArchivedJobsPage.Recordpp(driver).getText().split("\n");
	  ...
	  for(int i=0; i<ddc; i++) {
		  ...
		  PageNavigation_Action.Execute1(driver, pagecount, dd_value, pageObjects.ArchivedJobsPage.Recordpp(driver));
