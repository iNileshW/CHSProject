...
public class TC_Archived_Patients_RecordPerPage {
  ...
  public void f() {
	  ...
	  String rcount = pageObjects.ArchivedPatientsPage.RecordCount(driver).getText();
	 // PageNavigation_Action.Execute(driver, pageObjects.ArchivedJobsPage.Recordpp(driver),rcount);
	  ...
	  String[] ddcount = pageObjects.ArchivedPatientsPage.Recordpp(driver).getText().split("\n");
	  ...
	  for(int i=0; i<ddc; i++) {
		  ...
		  PageNavigation_Action.Execute1(driver, pagecount, dd_value, pageObjects.ArchivedPatientsPage.Recordpp(driver));
