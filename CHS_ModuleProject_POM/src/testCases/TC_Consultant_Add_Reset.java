...
public class TC_Consultant_Add_Reset {
  ...
  public void f() {
	  ...
	  pageObjects.AddNewConsultant.Consultant_Txtbox(driver).sendKeys(Constant.Consultant_Name1);
	  pageObjects.AddNewConsultant.Reset_Button(driver).click();
	  assertEquals("",pageObjects.AddNewConsultant.Consultant_Txtbox(driver).getText());
	  pageObjects.AddNewConsultant.backtolist(driver).click();
