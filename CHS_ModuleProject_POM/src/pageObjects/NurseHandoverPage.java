 ...
 *
 */
public class NurseHandoverPage {

private static WebElement element = null;
	

	public static WebElement Nurse_Handover_Page(WebDriver driver) {
	...
	public static WebElement Notes(WebDriver driver) {
		element = driver.findElement(By.xpath("html/body/form[2]/table/tbody/tr[1]/td[12]/table/tbody/tr/td[1]/a"));
				return element;
	}
